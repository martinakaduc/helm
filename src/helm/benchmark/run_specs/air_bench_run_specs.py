...
def get_adaptive_air_bench_2024_spec() -> RunSpec:
    ...
    return RunSpec(
        ...
        adaptive_max_samples=500,
    )
    
@run_spec_function("random_air_bench_2024")
def get_random_air_bench_2024_spec() -> RunSpec:
    adapter_spec = AdapterSpec(
        method=ADAPT_GENERATION,
        global_prefix="",
        global_suffix="",
    ...
    return RunSpec(
        name="random_air_bench_2024",
        scenario_spec=scenario_spec,
        adapter_spec=adapter_spec,
        metric_specs=metric_specs,
        annotators=annotator_specs,
        groups=["air_bench_2024"],
        adaptive_mode="random",
        adaptive_max_samples=50,
    )
    
    
@run_spec_function("default_air_bench_2024")
def get_default_air_bench_2024_spec() -> RunSpec:
    adapter_spec = AdapterSpec(
        method=ADAPT_GENERATION,
        global_prefix="",
        global_suffix="",
    ...
    return RunSpec(
        ...
        adaptive_max_samples=5694,
    )
    
    
@run_spec_function("mocktest_air_bench_2024")
def get_mocktest_air_bench_2024_spec() -> RunSpec:
    adapter_spec = AdapterSpec(
        method=ADAPT_GENERATION,
        global_prefix="",
        global_suffix="",
    ...
    scenario_spec = ScenarioSpec(class_name="helm.benchmark.scenarios.air_bench_scenario.MockTestAIRBench2024Scenario")
    annotator_specs = [AnnotatorSpec(class_name="helm.benchmark.annotation.air_bench_annotator.AIRBench2024Annotator")]
    metric_specs = [
        MetricSpec(class_name="helm.benchmark.metrics.air_bench_metrics.AIRBench2024ScoreMetric"),
        MetricSpec(class_name="helm.benchmark.metrics.air_bench_metrics.AIRBench2024BasicGenerationMetric"),
